...
class GetWeather {
    ...
    // API取得の開始処理
    func getAPIData() {
        let URL = NSURL(string: "http://api.openweathermap.org/data/2.5/forecast/daily?lat=35.662292&lon=139.760744&mode=json&cnt=14&APPID=f7c8d5c740cd08b96df59d1775ef82ac")
